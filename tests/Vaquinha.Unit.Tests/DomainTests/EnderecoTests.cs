...
namespace Vaquinha.Unit.Tests.DomainTests
{
    ...
    public class EnderecoTests: IClassFixture<EnderecoFixture>
    {
        ...
        [Fact]
        [Trait("Endereco", "Endereco_CorretamentePreenchido_EnderecoValido2")]
        public void Endereco_CorretamentePreenchido_EnderecoValido2()
        {
            // Arrange
            var endereco = _fixture.EnderecoValido2();
